                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath }/minhasempresas.html">Listar Minhas Empresas</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath }/meusprodutos.html">Listar Meus Produtos</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
