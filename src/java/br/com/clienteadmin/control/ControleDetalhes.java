 ...
 * @author Guilherme
 */
@WebServlet(name = "ControleDetalhes", urlPatterns = {"/ControleDetalhes", "/detalhesempresa.html"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(url.equalsIgnoreCase("/detalhesempresa.html")) {
            ...
            try {
                ...
                String resp = client
                                .target("http://localhost:8080/ServidorAplicativo/webresources/Empresa/getEmpresa/"+id)
