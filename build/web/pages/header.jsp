            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath }/pages/index.jsp"><i class="fa fa-dashboard fa-fw"></i> Principal</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Empresa<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="${pageContext.request.contextPath }/pages/cadastrarempresa.jsp">Cadastrar Empresa</a>
                                </li>
                                <li>
                                    <a href="${pageContext.request.contextPath }/pages/buscarempresa.jsp">Buscar Empresa</a>
                                </li>
                                <li>
                                    <a href="${pageContext.request.contextPath }/pages/minhasempresas.jsp">Listar Minhas Empresas</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath }/pages/meusprodutos.jsp">Listar Meus Produtos</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="tables.html"><i class="fa fa-table fa-fw"></i> Adicionar Imagem</a>
                        </li>
                        <li>
